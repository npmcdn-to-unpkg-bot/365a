...
CWM_VERSION_6043="6.0.4.3"
CWM_VERSION_6044="6.0.4.4"
CWM_VERSION_6045="6.0.4.5"
CWM_VERSION_6047="6.0.4.7"
CWM_SIZE=
...
TARGET_RELEASE_FOLDER="/sdcard/ubuntu_release"
...
detect_device() {
    ...
    RECOVERY_URL=$URL_CWM_PATH_BASE-$CWM_VERSION-$DEVICE.img
    RECOVERY_IMAGE=$RECOVERY-$DEVICE-$CWM_VERSION.img
}
...
download_recovery() {
    ...
    download_file $RECOVERY_URL $RECOVERY_IMAGE $CWM_SIZE
}
